...
##export PS1="$USER@`/bin/hostname -s`-> "
export PGPORT=1921
export PGDATA=/home/wangji/pginstall/data
export LANG=en_US.utf8
export PGHOME=/home/wangji/pginstall/
...
cd postgresql-9.6.1
export USE_UNNAMED_POSIX_SEMAPHORES=1
##./configure --prefix /home/wangji/pg14/pginstall --with-pgport=5433 --enable-debug --enable-cassert --enable-depend CFLAGS='-O0 -g3 -ggdb3'
##LIBS=-lpthread  CFLAGS="-O0 -flto -g -ggdb -fno-omit-frame-pointer" make world -j 64
##LIBS=-lpthread  CFLAGS="-O0 -flto -g -ggdb -fno-omit-frame-pointer" make install-world

LIBS=-lpthread CC="/home/digoal/gcc6.2.0/bin/gcc" CFLAGS="-O0 -flto -g -ggdb -fno-omit-frame-pointer" ./configure --prefix=/home/wangji/pg14/pginstall --enable-cassert
